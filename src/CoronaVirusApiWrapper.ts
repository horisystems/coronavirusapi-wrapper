...
export default class CoronaVirusApiWrapper {
  ...
  getDec2020(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("dec-2020")));
  }

  getJan2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("jan-2021")));
  }

  getFeb2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("feb-2021")));
  }

  getMar2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("mar-2021")));
  }

  getApr2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("apr-2021")));
  }

  getMay2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("may-2021")));
  }

  getJun2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("jun-2021")));
  }

  getJul2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("jul-2021")));
  }

  getAug2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("aug-2021")));
  }

  getSep2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("sep-2021")));
  }

  getOct2021(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("oct-2021")));
  }

  getNov2021(): Promise<IGlobalDailyReport | Error> {
  ...
  getFeb2022(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("feb-2022")));
  }

  getMar2022(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("mar-2022")));
  }

  getApr2022(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("apr-2022")));
  }

  getMay2022(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("may-2022")));
  }

  getJun2022(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("jun-2022")));
  }

  getJul2022(): Promise<IGlobalDailyReport | Error> {
    return this.getReportsAt(new Date(Date.parse("jul-2022")));
  }
